...
public abstract class Mp4TagField implements TagField
{
    ...
    {
        return Utils.getBytes(getId(), StandardCharsets.ISO_8859_1);
    }
    ...
    public byte[] getRawContent() throws UnsupportedEncodingException
    {
        ...
        try
        {
            ...
            outerbaos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(Mp4BoxHeader.HEADER_LENGTH + databox.length));
            outerbaos.write(Utils.toBytes(getId(), StandardCharsets.ISO_8859_1));
    ...
    public byte[] getRawContentDataOnly() throws UnsupportedEncodingException
    {
        ...
        try
        {
            ...
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(Mp4DataBox.DATA_HEADER_LENGTH + data.length));
