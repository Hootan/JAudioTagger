...
public class Mp4Tag extends AbstractTag
{
  ...
  /**
    ...
    public String getTitle2() {
        return getFirst(Mp4FieldKey.TITLE);
    }

    @Override
    public String getComment2() {
        return getFirst(Mp4FieldKey.COMMENT);
    }

    @Override
    public String getArtist2() {
        return getFirst(Mp4FieldKey.ARTIST);
    }

    @Override
    public String getAlbumArtist2() {
        return getFirst(Mp4FieldKey.ALBUM_ARTIST);
    }

    @Override
    public String getAlbum2() {
        return getFirst(Mp4FieldKey.ALBUM);
    }

    @Override
    public String getGenre2() {
        String genre = getFirst(Mp4FieldKey.GENRE_CUSTOM);
        if (TextUtils.isEmpty(genre))
            genre = getFirst(Mp4FieldKey.GENRE);
        return genre;
    }

    @Override
    public String getYear2() {
        return getFirst(Mp4FieldKey.DAY);
    }

    @Override
    public String getComposer2() {
        return getFirst(Mp4FieldKey.COMPOSER);
    }

    @Override
    public String getPublisher2() {
        return getFirst(Mp4FieldKey.ARRANGER);
    }

    @Override
    public String getEncoder2() {
        return getFirst(Mp4FieldKey.ENCODER);
    }

    @Override
    public String getCopyright2() {
        return getFirst(Mp4FieldKey.COPYRIGHT);
    }

    @Override
    public String getTrack2() {
        return getFirst(Mp4FieldKey.TRACK);
    }

    @Override
    public String getDisc2() {
        return getFirst(Mp4FieldKey.DISCNUMBER);
    }

    @Override
    public String getLyrics2() {
        return getFirst(Mp4FieldKey.LYRICS);
    }

    @Override
    public String getItunesNorm() {
        return getFirst(Mp4FieldKey.ITUNES_NORM);
    }

    @Override
    public String getItunesSMPB() {
        return getFirst(Mp4FieldKey.ITUNES_SMPB);
    }
