...
public class FlacTag implements Tag
{
    ...
    {
        //Add to image list
        return new MetadataBlockDataPicture(Utils.getBytes(url, StandardCharsets.ISO_8859_1), PictureTypes.DEFAULT_ID, MetadataBlockDataPicture.IMAGE_IS_URL, "", 0, 0, 0, 0);
    }
    ...
    public TagField createField(Artwork artwork) throws FieldDataInvalidException
    {
        if(artwork.isLinked())
        {
            return new MetadataBlockDataPicture(
                    Utils.getBytes(artwork.getImageUrl(), StandardCharsets.ISO_8859_1),
    ...
    public String getTitle2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.TITLE);
    }

    @Override
    public String getComment2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.COMMENT);
    }

    @Override
    public String getArtist2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.ARTIST);
    }

    @Override
    public String getAlbumArtist2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.ALBUMARTIST);
    }

    @Override
    public String getAlbum2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.ALBUM);
    }

    @Override
    public String getGenre2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.GENRE);
    }

    @Override
    public String getYear2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.DATE);
    }

    @Override
    public String getComposer2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.COMPOSER);
    }

    @Override
    public String getPublisher2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.ORGANIZATION);
    }

    @Override
    public String getEncoder2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.ENCODER);
    }

    @Override
    public String getCopyright2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.COPYRIGHT);
    }

    @Override
    public String getTrack2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.TRACKNUMBER);
    }

    @Override
    public String getDisc2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.DISCNUMBER);
    }

    @Override
    public String getLyrics2() {
        return getVorbisCommentTag().getFirst(VorbisCommentFieldKey.LYRICS);
    }
    ...
    public Object[] getArtwork2() {
        try {
            List<MetadataBlockDataPicture> images = getImages();
            byte[] bytes = images.size() > 0 ? images.get(0).getImageData() : null;
            return bytes != null ? new Object[]{images.get(0).getMimeType(), bytes} : null;
        } catch (Throwable e) {
            return null;
        }
    }
    ...
    public void setTitle2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.TITLE, data));
    }

    @Override
    public void setComment2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.COMMENT, data));
    }

    @Override
    public void setArtist2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.ARTIST, data));
    }

    @Override
    public void setAlbumArtist2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.ALBUMARTIST, data));
    }

    @Override
    public void setAlbum2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.ALBUM, data));
    }

    @Override
    public void setGenre2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.GENRE, data));
    }

    @Override
    public void deleteGenre2() throws Throwable {
        getVorbisCommentTag().deleteField(VorbisCommentFieldKey.GENRE);
    }

    @Override
    public void deleteTrack2() throws Throwable {
        getVorbisCommentTag().deleteField(VorbisCommentFieldKey.TRACKNUMBER);
    }

    @Override
    public void deleteDisc2() throws Throwable {
        getVorbisCommentTag().deleteField(VorbisCommentFieldKey.DISCNUMBER);
    }

    @Override
    public void deleteYear2() throws Throwable {
        getVorbisCommentTag().deleteField(VorbisCommentFieldKey.DATE);
    }

    @Override
    public void setYear2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.DATE, data));
    }

    @Override
    public void setComposer2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.COMPOSER, data));
    }

    @Override
    public void setPublisher2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.ORGANIZATION, data));
    }

    @Override
    public void setEncoder2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.ENCODER, data));
    }

    @Override
    public void setCopyright2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.COPYRIGHT, data));
    }

    @Override
    public void setTrack2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.TRACKNUMBER, data));
    }

    @Override
    public void setDisc2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.DISCNUMBER, data));
    }

    @Override
    public void setLyrics2(String data) throws Throwable {
        getVorbisCommentTag().setField(createField(VorbisCommentFieldKey.LYRICS, data));
    }
