...
public class VorbisCommentTag extends AbstractTag
{
     ...
     */
      public TagField createField(Artwork artwork) throws FieldDataInvalidException
      {
        try
        {
            ...
            String base64image = Utils.getString(testdata);
    ...
    public String getTitle2() {
        return getFirst(VorbisCommentFieldKey.TITLE);
    }

    @Override
    public String getComment2() {
        return getFirst(VorbisCommentFieldKey.COMMENT);
    }

    @Override
    public String getArtist2() {
        return getFirst(VorbisCommentFieldKey.ARTIST);
    }

    @Override
    public String getAlbumArtist2() {
        return getFirst(VorbisCommentFieldKey.ALBUMARTIST);
    }

    @Override
    public String getAlbum2() {
        return getFirst(VorbisCommentFieldKey.ALBUM);
    }

    @Override
    public String getGenre2() {
        return getFirst(VorbisCommentFieldKey.GENRE);
    }

    @Override
    public String getYear2() {
        return getFirst(VorbisCommentFieldKey.DATE);
    }

    @Override
    public String getComposer2() {
        return getFirst(VorbisCommentFieldKey.COMPOSER);
    }

    @Override
    public String getPublisher2() {
        return getFirst(VorbisCommentFieldKey.ORGANIZATION);
    }

    @Override
    public String getEncoder2() {
        return getFirst(VorbisCommentFieldKey.ENCODER);
    }

    @Override
    public String getCopyright2() {
        return getFirst(VorbisCommentFieldKey.COPYRIGHT);
    }

    @Override
    public String getTrack2() {
        return getFirst(VorbisCommentFieldKey.TRACKNUMBER);
    }

    @Override
    public String getDisc2() {
        return getFirst(VorbisCommentFieldKey.DISCNUMBER);
    }

    @Override
    public String getLyrics2() {
        return getFirst(VorbisCommentFieldKey.LYRICS);
    }
    ...
    public void setTitle2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.TITLE, data));
    }

    @Override
    public void setComment2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.COMMENT, data));
    }

    @Override
    public void setArtist2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.ARTIST, data));
    }

    @Override
    public void setAlbumArtist2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.ALBUMARTIST, data));
    }

    @Override
    public void setAlbum2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.ALBUM, data));
    }

    @Override
    public void setGenre2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.GENRE, data));
    }

    @Override
    public void deleteGenre2() throws Throwable {
        deleteField(VorbisCommentFieldKey.GENRE);
    }

    @Override
    public void deleteTrack2() throws Throwable {
        deleteField(VorbisCommentFieldKey.TRACKNUMBER);
    }

    @Override
    public void deleteDisc2() throws Throwable {
        deleteField(VorbisCommentFieldKey.DISCNUMBER);
    }

    @Override
    public void deleteYear2() throws Throwable {
        deleteField(VorbisCommentFieldKey.DATE);
    }

    @Override
    public void setYear2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.DATE, data));
    }

    @Override
    public void setComposer2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.COMPOSER, data));
    }

    @Override
    public void setPublisher2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.ORGANIZATION, data));
    }

    @Override
    public void setEncoder2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.ENCODER, data));
    }

    @Override
    public void setCopyright2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.COPYRIGHT, data));
    }

    @Override
    public void setTrack2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.TRACKNUMBER, data));
    }

    @Override
    public void setDisc2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.DISCNUMBER, data));
    }

    @Override
    public void setLyrics2(String data) throws Throwable {
        setField(createField(VorbisCommentFieldKey.LYRICS, data));
    }
