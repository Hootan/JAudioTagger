...
public final class AsfTag extends AbstractTag
{
    ...
    public String getTitle2() {
        return getFirst(AsfFieldKey.TITLE);
    }

    @Override
    public String getComment2() {
        return getFirst(AsfFieldKey.DESCRIPTION);
    }

    @Override
    public String getArtist2() {
        return getFirst(AsfFieldKey.AUTHOR);
    }

    @Override
    public String getAlbumArtist2() {
        return getFirst(AsfFieldKey.ALBUM_ARTIST);
    }

    @Override
    public String getAlbum2() {
        return getFirst(AsfFieldKey.ALBUM);
    }

    @Override
    public String getGenre2() {
        return getFirst(AsfFieldKey.GENRE);
    }

    @Override
    public String getYear2() {
        return getFirst(AsfFieldKey.YEAR);
    }

    @Override
    public String getComposer2() {
        return getFirst(AsfFieldKey.COMPOSER);
    }

    @Override
    public String getPublisher2() {
        return getFirst(AsfFieldKey.RECORD_LABEL);
    }

    @Override
    public String getEncoder2() {
        return getFirst(AsfFieldKey.ENCODER);
    }

    @Override
    public String getCopyright2() {
        return getFirst(AsfFieldKey.COPYRIGHT);
    }

    @Override
    public String getTrack2() {
        return getFirst(AsfFieldKey.TRACK);
    }

    @Override
    public String getDisc2() {
        return getFirst(AsfFieldKey.DISC_NO);
    }

    @Override
    public String getLyrics2() {
        return getFirst(AsfFieldKey.LYRICS);
    }
    ...
    public void setTitle2(String data) throws Throwable {
        setField(createField(AsfFieldKey.TITLE, data));
    }

    @Override
    public void setComment2(String data) throws Throwable {
        setField(createField(AsfFieldKey.DESCRIPTION, data));
    }

    @Override
    public void setArtist2(String data) throws Throwable {
        setField(createField(AsfFieldKey.AUTHOR, data));
    }

    @Override
    public void setAlbumArtist2(String data) throws Throwable {
        setField(createField(AsfFieldKey.ALBUM_ARTIST, data));
    }

    @Override
    public void setAlbum2(String data) throws Throwable {
        setField(createField(AsfFieldKey.ALBUM, data));
    }

    @Override
    public void setGenre2(String data) throws Throwable {
        setField(createField(AsfFieldKey.GENRE, data));
    }
