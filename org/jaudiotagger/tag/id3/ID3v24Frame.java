...
public class ID3v24Frame extends AbstractID3v2Frame
{
        ...
        if (frameSize > ID3SyncSafeInteger.MAX_SAFE_SIZE)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    String readAheadIdentifier = Utils.getString(readAheadbuffer);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                byteBuffer.get(readAheadbuffer, 0, getFrameIdSize());
                                readAheadIdentifier = Utils.getString(readAheadbuffer);
    ...
    public void write(ByteArrayOutputStream tagBuffer)
    {
        ...
        headerBuffer.put(Utils.getBytes(getIdentifier(), StandardCharsets.ISO_8859_1), 0, FRAME_ID_SIZE);
