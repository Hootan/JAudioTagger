...
public class ID3v1TagField implements TagTextField
{
    ...
    {
        String field = Utils.toString(raw, StandardCharsets.ISO_8859_1);
    ...
    public byte[] getRawContent() throws UnsupportedEncodingException
    {
        ...
        byte[] idBytes = Utils.toBytes(this.id, StandardCharsets.ISO_8859_1);
        byte[] contentBytes = Utils.toBytes(this.content, StandardCharsets.ISO_8859_1);
