...
public class FrameBodyPIC extends AbstractID3v2FrameBody implements ID3v22FrameBody
{
    ...
    public String getImageUrl()
    {
        if (isImageUrl())
        {
            return Utils.getString(((byte[]) getObjectValue(DataTypes.OBJ_PICTURE_DATA)), 0, ((byte[]) getObjectValue(DataTypes.OBJ_PICTURE_DATA)).length, StandardCharsets.ISO_8859_1);
        }
        else
        {
            return "";
