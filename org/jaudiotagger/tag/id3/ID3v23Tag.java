...
public class ID3v23Tag extends AbstractID3v2Tag
{
     ...
     *
     * @param provider The file to write to
     * @throws IOException
     */
    public long write(FileSystemProvider provider, long audioStartLocation) throws IOException
    {
        setLoggingFilename(provider.getName());
        ...
        writeBufferToFile(provider, headerBuffer, bodyByteBuffer, padding, sizeIncPadding, audioStartLocation);
    ...
    public TagField createField(Artwork artwork) throws FieldDataInvalidException
    {
        ...
        else
        {
            try
            {
                body.setObjectValue(DataTypes.OBJ_PICTURE_DATA, Utils.toBytes(artwork.getImageUrl(), StandardCharsets.ISO_8859_1));
            }
