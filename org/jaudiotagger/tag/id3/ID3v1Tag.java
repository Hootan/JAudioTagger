...
public class ID3v1Tag extends AbstractID3v1Tag implements Tag
{
     ...
     * @throws IOException
     */
    public ID3v1Tag(RandomAccessFileProvider file, String loggingFilename) throws TagNotFoundException, IOException
    {
     ...
     * @throws TagNotFoundException
     * @throws IOException
     * @deprecated use {@link #ID3v1Tag(RandomAccessFileProvider,String)} instead
     */
    public ID3v1Tag(RandomAccessFileProvider file) throws TagNotFoundException, IOException
    {
        this(file, "");
    }
