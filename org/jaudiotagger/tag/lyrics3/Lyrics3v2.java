...
public class Lyrics3v2 extends AbstractLyrics3
{
     ...
     * @throws IOException
     */
    public boolean seek(RandomAccessFileProvider file) throws IOException
    {
        ...
        lyricEnd = Utils.toString(buffer, 0, 9);
    ...
    private int seekSize(ByteBuffer byteBuffer)
    {
        ...
        file.seek(file.length() - 128 - 9);
        file.read(buffer, 0, 9);
        lyricEnd = GlobalUtils.toString(buffer, 0, 9);
        ...
        return Integer.parseInt(GlobalUtils.toString(buffer, 0, 6));
        */
        return -1;
    }
}