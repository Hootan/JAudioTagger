...
public class FieldFrameBodyIMG extends AbstractLyrics3v2FieldFrameBody
{
    ...
    public void read(ByteBuffer byteBuffer) throws InvalidTagException
    {
        ...
        int size = Integer.parseInt(Utils.toString(buffer, 0, 5));
        ...
        imageString = Utils.getString(buffer);
        readString(imageString);
    }
     ...
     */
    public void write(RandomAccessFileProvider file) throws java.io.IOException
    {
        int size;
        int offset = 0;
        byte[] buffer = new byte[5];
