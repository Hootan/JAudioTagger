...
public abstract class AbstractLyrics3v2FieldFrameBody extends AbstractTagFrameBody
{
     ...
     * @throws IOException
     */
    protected int readHeader(RandomAccessFileProvider file) throws InvalidTagException, IOException
    {
        int size;
        ...
        size = Integer.parseInt(Utils.toString(buffer, 0, 5));
     ...
     * @throws IOException
     */
    protected void writeHeader(RandomAccessFileProvider file, int size) throws IOException
    {
        String str;
        int offset = 0;
        byte[] buffer = new byte[5];
