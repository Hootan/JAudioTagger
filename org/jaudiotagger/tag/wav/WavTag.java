...
public class WavTag implements Tag, Id3SupportingTag
{
    ...
    {
        if (id3Tag != null)
            id3Tag.setField(createField(artwork));
    }
    ...
    public void syncToId3FromInfoIfEmpty()
    {
        ...
        try
        {
            ...
            {
                if (TextUtils.isEmpty(id3Tag.getFirst(fieldKey)))
                {
    ...
    public void syncToInfoFromId3IfEmpty()
    {
        ...
        try
        {
            for(FieldKey fieldKey : WavInfoTag.getSupportedKeys())
            {
                if (TextUtils.isEmpty(infoTag.getFirst(fieldKey)))
                {
                    if (!TextUtils.isEmpty(id3Tag.getFirst(fieldKey)))
                    {
    ...
    public String getTitle2() {
        return getActiveTag().getFirst(FieldKey.TITLE);
    }

    @Override
    public String getComment2() {
        return getActiveTag().getFirst(FieldKey.COMMENT);
    }

    @Override
    public String getArtist2() {
        return getActiveTag().getFirst(FieldKey.ARTIST);
    }

    @Override
    public String getAlbumArtist2() {
        return getActiveTag().getFirst(FieldKey.ALBUM_ARTIST);
    }

    @Override
    public String getAlbum2() {
        return getActiveTag().getFirst(FieldKey.ALBUM);
    }

    @Override
    public String getGenre2() {
        return getActiveTag().getFirst(FieldKey.GENRE);
    }

    @Override
    public String getYear2() {
        return getActiveTag().getFirst(FieldKey.YEAR);
    }

    @Override
    public String getComposer2() {
        return getActiveTag().getFirst(FieldKey.COMPOSER);
    }

    @Override
    public String getPublisher2() {
        return getActiveTag().getFirst(FieldKey.RECORD_LABEL);
    }

    @Override
    public String getEncoder2() {
        return getActiveTag().getFirst(FieldKey.ENCODER);
    }

    @Override
    public String getCopyright2() {
        return getActiveTag().getFirst(FieldKey.COPYRIGHT);
    }

    @Override
    public String getTrack2() {
        return getActiveTag().getFirst(FieldKey.TRACK);
    }

    @Override
    public String getDisc2() {
        return getActiveTag().getFirst(FieldKey.DISC_NO);
    }

    @Override
    public String getLyrics2() {
        return getActiveTag().getFirst(FieldKey.LYRICS);
    }
    ...
    public Object[] getArtwork2() {
        try {
            if (id3Tag != null) {
                Artwork artwork = id3Tag.getFirstArtwork();
