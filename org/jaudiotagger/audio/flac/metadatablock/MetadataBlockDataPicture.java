...
public class MetadataBlockDataPicture implements MetadataBlockData, TagField
{
    ...
    public MetadataBlockDataPicture(MetadataBlockHeader header, FileChannelProvider fc ) throws IOException, InvalidFrameException
    {
    ...
    private String getString(ByteBuffer rawdata, int length, String charset) throws IOException
    {
        ...
        return Utils.getString(tempbuffer, charset);
    }
    ...
    public ByteBuffer getBytes()
    {
        try
        {
            ...
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(pictureType));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(mimeType.length()));
            baos.write(Utils.toBytes(mimeType, StandardCharsets.ISO_8859_1));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(description.length()));
            baos.write(Utils.toBytes(description, StandardCharsets.UTF_8));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(width));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(height));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(colourDepth));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(indexedColouredCount));
            baos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(imageData.length));
    ...
    public String getImageUrl()
    {
        if (isImageUrl())
        {
            return Utils.getString(getImageData(), 0, getImageData().length, StandardCharsets.ISO_8859_1);
        }
        else
        {
            return "";
