...
public class VideoStreamChunk extends StreamChunk
{
    ...
    public String getCodecIdAsString()
    {
        ...
        {
            result = Utils.getString(getCodecId());
        }
        return result;
    }
    ...
    public String prettyPrint(final String prefix)
    {
        ...
        result.insert(0, org.jaudiotagger.audio.asf.util.Utils.LINE_SEPARATOR + prefix + "|->VideoStream");
        result.append(prefix).append("Video info:").append(org.jaudiotagger.audio.asf.util.Utils.LINE_SEPARATOR);
        result.append(prefix).append("      |->Width  : ").append(getPictureWidth()).append(org.jaudiotagger.audio.asf.util.Utils.LINE_SEPARATOR);
        result.append(prefix).append("      |->Heigth : ").append(getPictureHeight()).append(org.jaudiotagger.audio.asf.util.Utils.LINE_SEPARATOR);
        result.append(prefix).append("      |->Codec  : ").append(getCodecIdAsString()).append(org.jaudiotagger.audio.asf.util.Utils.LINE_SEPARATOR);
