...
public class MetadataDescriptor implements Comparable<MetadataDescriptor>, Cloneable
{
    ...
    public String getString()
    {
        ...
        switch (getType())
        {
            ...
            case TYPE_STRING:
                try
                {
                    result = Utils.toString(this.content, StandardCharsets.UTF_16LE);
                }
    ...
    public void setDWordValue(final long value)
    {
        ...
        this.content = org.jaudiotagger.audio.asf.util.Utils.getBytes(value, 4);
    ...
    public void setQWordValue(final long value)
    {
        ...
        this.content = org.jaudiotagger.audio.asf.util.Utils.getBytes(value, 8);
        this.descriptorType = TYPE_QWORD;
    }
    ...
    public void setStringValue(final String value) throws IllegalArgumentException
    {
        ...
        {
            final byte[] tmp = org.jaudiotagger.audio.asf.util.Utils.getBytes(value, AsfHeader.ASF_CHARSET);
    ...
    public void setWordValue(final int value) throws IllegalArgumentException
    {
        ...
        this.content = org.jaudiotagger.audio.asf.util.Utils.getBytes(value, 2);
    ...
    public int writeInto(final OutputStream out, final ContainerType contType) throws IOException
    {
        ...
        {
            org.jaudiotagger.audio.asf.util.Utils.writeUINT16(getLanguageIndex(), out);
            org.jaudiotagger.audio.asf.util.Utils.writeUINT16(getStreamNumber(), out);
        }
        org.jaudiotagger.audio.asf.util.Utils.writeUINT16(getName().length() * 2 + 2, out);

        // The name for the metadata objects come later
        if (contType == ContainerType.EXTENDED_CONTENT)
        {
            out.write(org.jaudiotagger.audio.asf.util.Utils.getBytes(getName(), AsfHeader.ASF_CHARSET));
            out.write(AsfHeader.ZERO_TERM);
        }

        // type and content len follow up are identical
        final int type = getType();
        org.jaudiotagger.audio.asf.util.Utils.writeUINT16(type, out);
        ...
        if (contType == ContainerType.EXTENDED_CONTENT)
        {
            org.jaudiotagger.audio.asf.util.Utils.writeUINT16(contentLen, out);
        }
        else
        {
            org.jaudiotagger.audio.asf.util.Utils.writeUINT32(contentLen, out);
        }
