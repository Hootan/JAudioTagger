...
class EncryptionChunkReader implements ChunkReader
{
    ...
    public Chunk read(final GUID guid, final InputStream stream, final long chunkStart) throws IOException
    {
        ...
        // Secret Data length
        int fieldLength;
        fieldLength = (int) org.jaudiotagger.audio.asf.util.Utils.readUINT32(stream);
        // Secret Data
        ...
        result.setSecretData(Utils.getString(secretData));
        result.setProtectionType(Utils.getString(protectionType));
        result.setKeyID(Utils.getString(keyID));
        result.setLicenseURL(Utils.getString(licenseURL));
