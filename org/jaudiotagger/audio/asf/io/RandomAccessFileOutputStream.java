...
/**
 * Wraps a {@link RandomAccessFileProvider} into an {@link OutputStream}.<br>
 *
...
public final class RandomAccessFileOutputStream extends OutputStream
{
     ...
     */
    private final RandomAccessFileProvider targetFile;
     ...
     */
    public RandomAccessFileOutputStream(final RandomAccessFileProvider target)
    {
        super();
