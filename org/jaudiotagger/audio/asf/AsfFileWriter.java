...
public class AsfFileWriter extends AudioFileWriter
{
     ...
     */
    @Override
    protected void deleteTag(Tag tag, final RandomAccessFileProvider raf, final RandomAccessFileProvider tempRaf) throws CannotWriteException, IOException
    {
     ...
     */
    @Override
    protected void writeTag(AudioFile audioFile, final Tag tag, final RandomAccessFileProvider raf, final RandomAccessFileProvider rafTemp) throws CannotWriteException, IOException
    {
        /*
