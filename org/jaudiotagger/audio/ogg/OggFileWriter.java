...
public class OggFileWriter extends AudioFileWriter
{
    ...
    protected void deleteTag(Tag tag, RandomAccessFileProvider raf, RandomAccessFileProvider tempRaf) throws CannotReadException, CannotWriteException, IOException
    {
