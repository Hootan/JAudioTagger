...
public class OggFileReader extends AudioFileReader
{
    ...
    protected Tag getTag(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
        return vtr.read(raf);
    }
     ...
     * @throws IOException
     */
    public OggPageHeader readOggPageHeader(RandomAccessFileProvider raf, int count) throws CannotReadException, IOException
    {
     ...
     * @throws IOException
     */
    public void summarizeOggPageHeaders(FileSystemProvider oggProvider) throws CannotReadException, IOException
    {
        RandomAccessFileProvider raf = oggProvider.getRandomAccessFile("r");
     ...
     * @throws IOException
     */
    public void shortSummarizeOggPageHeaders(FileSystemProvider oggProvider) throws CannotReadException, IOException
    {
        RandomAccessFileProvider raf = oggProvider.getRandomAccessFile("r");
