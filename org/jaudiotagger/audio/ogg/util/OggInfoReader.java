...
public class OggInfoReader
{
    ...
    public GenericAudioHeader read(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
        ...
        {
            //CBR (in kbps)
            info.setBitRate(vorbisIdentificationHeader.getNominalBitrate() / org.jaudiotagger.audio.generic.Utils.KILOBYTE_MULTIPLIER);
    ...
    private int computeBitrate(int length, long size)
    {
        ...
        return (int) ((size / org.jaudiotagger.audio.generic.Utils.KILOBYTE_MULTIPLIER) * org.jaudiotagger.audio.generic.Utils.BITS_IN_BYTE_MULTIPLIER / length);
    }
}
