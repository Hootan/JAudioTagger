...
public class OggPageHeader
{
    ...
    public static OggPageHeader read(ByteBuffer byteBuffer) throws IOException, CannotReadException
       {
           ...
           {
               throw new CannotReadException(ErrorMessage.OGG_HEADER_CANNOT_BE_FOUND.getMsg(Utils.getString(b)));
           }
     ...
     * @throws CannotReadException
     */
    public static OggPageHeader read(RandomAccessFileProvider raf) throws IOException, CannotReadException
    {
    ...
    public OggPageHeader(byte[] b)
    {
        ...
        if (streamStructureRevision == 0)
        {
            ...
            streamSerialNumber = org.jaudiotagger.audio.generic.Utils.getIntLE(b, FIELD_STREAM_SERIAL_NO_POS, 17);
            pageSequenceNumber = org.jaudiotagger.audio.generic.Utils.getIntLE(b, FIELD_PAGE_SEQUENCE_NO_POS, 21);
            checksum = org.jaudiotagger.audio.generic.Utils.getIntLE(b, FIELD_PAGE_CHECKSUM_POS, 25);
