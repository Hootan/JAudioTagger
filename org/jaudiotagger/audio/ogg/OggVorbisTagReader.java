...
public class OggVorbisTagReader
{
     ...
     * @throws IOException
     */
    public Tag read(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
     ...
     * @throws IOException
     */
    public int readOggVorbisRawSize(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
        byte[] rawVorbisCommentData = readRawPacketData(raf);
     ...
     * @throws IOException
     */
    public byte[] readRawPacketData(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
    ...
    {
        String vorbis = Utils.getString(headerData, VorbisHeader.FIELD_CAPTURE_PATTERN_POS, VorbisHeader.FIELD_CAPTURE_PATTERN_LENGTH, StandardCharsets.ISO_8859_1);
     ...
     * @return
     */
    private byte[] convertToVorbisCommentPacket(OggPageHeader startVorbisCommentPage, RandomAccessFileProvider raf) throws IOException, CannotReadException
    {
     ...
     * @return
     */
    public byte[] convertToVorbisSetupHeaderPacket(long fileOffsetOfStartingOggPage, RandomAccessFileProvider raf) throws IOException, CannotReadException
    {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
     ...
     * @return
     */
    public byte[] convertToVorbisSetupHeaderPacketAndAdditionalPackets(long fileOffsetOfStartingOggPage, RandomAccessFileProvider raf) throws IOException, CannotReadException
    {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
     ...
     * @throws IOException
     */
    public OggVorbisHeaderSizes readOggVorbisHeaderSizes(RandomAccessFileProvider raf) throws CannotReadException, IOException
    {
        ...
        else
        {
            ...
            if (!isVorbisSetupHeader(b))
            {
                logger.warning("Expecting but got:"+ Utils.getString(b)+ "at "+(raf.getFilePointer()  - b.length));
                throw new CannotReadException(ErrorMessage.OGG_VORBIS_NO_VORBIS_HEADER_FOUND.getMsg());
            }
            raf.seek(raf.getFilePointer() - (VorbisHeader.FIELD_PACKET_TYPE_LENGTH + VorbisHeader.FIELD_CAPTURE_PATTERN_LENGTH));
            logger.config("Found start of vorbis setup header at file position:" + raf.getFilePointer());
