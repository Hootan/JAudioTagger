...
public class IffHeaderChunk
{
     ...
     * @throws IOException
     */
    public static void ensureOnEqualBoundary(final RandomAccessFileProvider raf, ChunkHeader chunkHeader) throws IOException
    {
    ...
    public static void ensureOnEqualBoundary(FileChannelProvider fc, ChunkHeader chunkHeader) throws IOException
    {
        if (Utils.isOddLength(chunkHeader.getSize()))
        {
            // Must come out to an even byte boundary unless at end of file
