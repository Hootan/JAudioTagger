...
public class GenericAudioHeader implements AudioHeader
{
    ...
    {
        //I added
        return noOfChannels != null ? noOfChannels : -1;
    }
    ...
    {
        return trackLength != null ? trackLength : 0;
    }
    ...
    {
        return samplingRate != null ? samplingRate : 0;
    }
    ...
    */
    ...
    private String mVideoCodecIdAsString;
    public void setCodecIdAsString(String codec) {
        mVideoCodecIdAsString = codec;
    }
    @Override
    public String getVideoCodecIdAsString() {
        return mVideoCodecIdAsString;
    }
