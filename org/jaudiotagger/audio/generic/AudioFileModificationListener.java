 ...
 * original has not been replaced yet. ({@link #fileModified(AudioFile, FileSystemProvider)}).</li>
 * <li>The operation has been finished. {@link #fileOperationFinished(FileSystemProvider)}</li>
 * </ul>
 *
...
public interface AudioFileModificationListener
{
     ...
     *                             in nothing.
     */
    public void fileModified(AudioFile original, FileSystemProvider temporary) throws ModifyVetoException;
     ...
     *               needed any more.
     */
    public void fileOperationFinished(FileSystemProvider result);
