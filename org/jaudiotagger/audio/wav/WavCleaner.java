...
public class WavCleaner
{
    ...
    public WavCleaner(FileSystemProvider provider)
    {
        this.provider = provider;
        this.loggingName= provider.getName();
    }
     ...
     */
    private int readChunk(FileChannelProvider fc) throws IOException, CannotReadException
    {
        Chunk chunk;
