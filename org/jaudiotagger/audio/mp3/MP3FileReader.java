...
public class MP3FileReader extends AudioFileReader
{
    ...
    public AudioFile read(FileSystemProvider f) throws IOException, TagException, ReadOnlyFileException, CannotReadException, InvalidAudioFrameException
    {
     ...
     */
    public AudioFile readMustBeWritable(FileSystemProvider f) throws IOException, TagException, ReadOnlyFileException, CannotReadException, InvalidAudioFrameException
    {
