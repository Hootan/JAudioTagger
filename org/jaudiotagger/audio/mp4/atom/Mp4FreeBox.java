...
public class Mp4FreeBox extends AbstractMp4Box
{
    ...
    public Mp4FreeBox(int datasize)
    {
        try
        {
            ...
            headerBaos.write(org.jaudiotagger.audio.generic.Utils.getSizeBEInt32(Mp4BoxHeader.HEADER_LENGTH + datasize));
            headerBaos.write(Utils.toBytes(Mp4AtomIdentifier.FREE.getFieldName(), StandardCharsets.ISO_8859_1));
