...
public class Mp4TagWriter
{
     ...
     * @throws IOException
     */
    private void writeMetadataSameSize(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader ilstHeader, ByteBuffer newIlstData, Mp4BoxHeader tagsHeader) throws CannotWriteException, IOException
    {
     ...
     * @throws IOException
     */
    private void writeNeroData(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader tagsHeader) throws IOException, CannotWriteException
    {
     ...
     * @throws CannotWriteException
     */
    private void writeOldMetadataLargerThanNewMetadata(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader moovHeader, Mp4BoxHeader udtaHeader, Mp4BoxHeader metaHeader, Mp4BoxHeader ilstHeader, Mp4BoxHeader mdatHeader, Mp4BoxHeader neroTagsHeader, ByteBuffer moovBuffer, ByteBuffer newIlstData, List<Mp4StcoBox> stcos, int sizeOfExistingMetaLevelFreeAtom) throws IOException, CannotWriteException
    {
     ...
     * @throws CannotWriteException
     */
    private void writeNewMetadataLargerButCanUseFreeAtom(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader ilstHeader, Mp4BoxHeader neroTagsHeader, int sizeOfExistingMetaLevelFreeAtom, ByteBuffer newIlstData, int additionalSpaceRequiredForMetadata) throws IOException, CannotWriteException
    {
     ...
     * @throws IOException
     */
    public void write(Tag tag, RandomAccessFileProvider raf, RandomAccessFileProvider rafTemp) throws CannotWriteException, IOException
    {
        logger.config("Started writing tag data");
        FileChannelProvider fileReadChannel = raf.getChannelProvider();
        FileChannelProvider fileWriteChannel = rafTemp.getChannelProvider();
    ...
    private void writeUpToMoovHeader(FileChannelProvider fileReadChannel,
                                     FileChannelProvider fileWriteChannel,
     ...
     * @throws CannotWriteException
     */
    private void writeDataInChunks(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel) throws IOException, CannotWriteException
    {
     ...
     * @throws IOException
     */
    private void convertandWriteTagsAtomToFreeAtom(FileChannelProvider fileWriteChannel, Mp4BoxHeader tagsHeader) throws IOException
    {
     ...
     * @throws IOException
     */
    private void writeDataUptoIncludingIlst(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader ilstHeader, ByteBuffer newIlstAtomData) throws IOException
    {
        fileReadChannel.position(0);
        fileWriteChannel.transferFrom(fileReadChannel, 0, ilstHeader.getFilePos());
        fileWriteChannel.position(ilstHeader.getFilePos());
     ...
     * @throws IOException
     */
    private void writeDataAfterIlst(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader tagsHeader) throws IOException, CannotWriteException
    {
        if (tagsHeader != null)
        {
     ...
     * @throws IOException
     */
    private void checkFileWrittenCorrectly(RandomAccessFileProvider rafTemp, Mp4BoxHeader mdatHeader, FileChannelProvider fileWriteChannel, List<Mp4StcoBox> stcos) throws CannotWriteException, IOException
    {
            ...
            for (int i=0; i<newStcos.size(); i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    if ((newStco.getFirstOffSet() - newMdatHeader.getFilePos()) != diff)
                    {
                        ...
                        Log.d("MP4", "Non standard file or corrupted but let's continue...");
     ...
     * @throws IOException
     */
    public void delete(RandomAccessFileProvider raf, RandomAccessFileProvider rafTemp) throws IOException
    {
     ...
     * @throws CannotWriteException
     */
    private void writeNoExistingUdtaAtom(FileChannelProvider fileReadChannel,
                                         FileChannelProvider fileWriteChannel,
    ...
    private void writeNoExistingMetaAtom(Mp4BoxHeader udtaHeader,
                                         FileChannelProvider fileReadChannel,
                                         FileChannelProvider fileWriteChannel,
                                         ByteBuffer newIlstData,
                                         Mp4BoxHeader moovHeader,
                                         ByteBuffer moovBuffer,
     ...
     * @throws IOException
     */
    private void writeFromEndOfIlstToNeroTagsAndMakeNeroFree(long endOfMoov, FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, Mp4BoxHeader neroTagsHeader)
            throws IOException
    {
        //Write from after ilst upto tags atom
     ...
     * @throws CannotWriteException
     */
    private void adjustFreeAtom(FileChannelProvider fileReadChannel, FileChannelProvider fileWriteChannel, int topLevelFreeSize, int additionalMetaSizeThatWontFitWithinMetaAtom)
            throws IOException, CannotWriteException
    {
