...
public class Mp4AtomTree
{
     ...
     */
    public Mp4AtomTree(RandomAccessFileProvider raf) throws IOException, CannotReadException
    {
        buildTree(raf, true);
    }
     ...
     * @throws CannotReadException
     */
    public Mp4AtomTree(RandomAccessFileProvider raf, boolean closeOnExit) throws IOException, CannotReadException
    {
     ...
     */
    public DefaultTreeModel buildTree(RandomAccessFileProvider raf, boolean closeExit) throws IOException, CannotReadException
    {
        FileChannelProvider fc = null;
        try
        {
            fc = raf.getChannelProvider();
