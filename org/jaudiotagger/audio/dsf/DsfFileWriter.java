...
{
    protected void writeTag(Tag tag, FileSystemProvider provider) throws CannotWriteException
    {
        try {
                ...
                if (dsd != null) {
                    if (dsd.getMetadataOffset() > 0) {
                        ...
                        if (id3Chunk != null) {
                            ...
                            throw new CannotWriteException(provider + "Could not find existing ID3v2 Tag");
                        }
                    } else {
     ...
     */
    @Override
    protected void deleteTag(Tag tag, FileSystemProvider provider) throws CannotWriteException
    {
        try {
            FileChannelProvider fc = FileChannelProvider.open(provider, StandardOpenOption.WRITE, StandardOpenOption.READ);
            try {
