...
public class DsdChunk
{
    ...
    {
        String type = org.jaudiotagger.audio.generic.Utils.readFourBytesAsChars(dataBuffer);
    ...
    public ByteBuffer write()
    {
        ...
        buffer.put(Utils.getBytes(DsfChunkType.DSD.getCode(), StandardCharsets.US_ASCII));
