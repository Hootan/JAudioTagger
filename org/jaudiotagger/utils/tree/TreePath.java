...
public class TreePath extends Object implements Serializable {
    ...
    public TreePath(Object[] path) {
        if(path == null || path.length == 0)
            throw new IllegalArgumentException("getPath in TreePath must be non null and not empty.");
    ...
    public TreePath(Object singlePath) {
        if(singlePath == null)
            throw new IllegalArgumentException("getPath in TreePath must be non null.");
